  // Initialize Firebase
  var config = {
   apiKey: "AIzaSyAm2IfErBzIoIv78qIZajmbYNKylWJE65o",
    authDomain: "rockpaper-64ebf.firebaseapp.com",
    databaseURL: "https://rockpaper-64ebf.firebaseio.com",
    projectId: "rockpaper-64ebf",
    storageBucket: "rockpaper-64ebf.appspot.com",
    messagingSenderId: "524581512659"
  };
...
//chatbox
        database.ref("/chatLog").on("child_added", function(childSnapshot){
            ...
            $("#chat-display").prepend(latestMessage);
